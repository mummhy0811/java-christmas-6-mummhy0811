...
public enum Menu {
    ...
    T_BONE_STEAK("메인","티본스테이크", 5500),
    BARBECUERIBS("메인","바비큐립", 5400),
    SEAFOOD_PASTA("메인","해산물파스타", 3500),
    CHRISTMAS_PASTA("메인","크리스마스파스타", 2500),

    CHOCO_CATEK("디저트", "초코케이크", 15000),
    ICECREAM("디저트", "아이스크림", 5000),

    ZERO_COKE("음료", "제로콜라", 3000),
    RED_WINE("음료", "레드와인", 60000),
    CHAMPAGNE("음료", "샴페인", 2500);
